...
(function (Msal) {
    ...
    var UserAgentApplication = (function () {
        console.info(" ");
        console.info("@UserAgentApplication()");
        console.info("-----------------------");
        function UserAgentApplication(clientId, authority, tokenReceivedCallback, _a) {
            
            console.log("clientId:" + clientId);
            console.log("authority:" + authority);
            console.log("tokenReceivedCallback:" + tokenReceivedCallback);
            console.log("_a:");
            console.dir(_a);
            ...
            this._cacheLocation = cacheLocation;
            console.info('Cache Location - Provided value:' + this._cacheLocation + '. Possible values are: ' + this._cacheLocations.localStorage + ', ' + this._cacheLocations.sessionStorage);
            if (!this._cacheLocations[cacheLocation]) {
                console.error('Cache Location is not valid. Provided value:' + this._cacheLocation + '.Possible values are: ' + this._cacheLocations.localStorage + ', ' + this._cacheLocations.sessionStorage);
            ...
            console.dir("new hash:");
            console.dir(hash);

            var isCallback = this.isCallback(window.location.hash);
            
            console.info("isCallback:");
            console.dir(isCallback);
        ...
        UserAgentApplication.prototype.handleAuthenticationResponse = function (hash) {
            console.info("@UserAgentApplication.prototype.handleAuthenticationResponse()");
            console.dir("hash:");
            console.dir(hash);
